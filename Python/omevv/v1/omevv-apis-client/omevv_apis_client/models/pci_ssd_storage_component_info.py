...
T = TypeVar("T", bound="PciSsdStorageComponentInfo")


@attr.s(auto_attribs=True)
class PciSsdStorageComponentInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pci_ssd_storage_component_info = cls(
            name=name,
            id=id,
            type=type,
        ...
        pci_ssd_storage_component_info.additional_properties = d
        return pci_ssd_storage_component_info
