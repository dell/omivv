...
from ...models.run_inventory_job_request import RunInventoryJobRequest
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: RunInventoryJobRequest,
) -> Dict[str, Any]:
    url = "{}/Consoles/{uuid}/Hosts/RunComplianceWithInventory".format(client.base_url, uuid=uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Refresh compliance and inventory

     Refresh compliance after trigerring device inventory
