...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/Consoles/{uuid}/ManagedHosts/WarrantyInformation".format(client.base_url, uuid=uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Get Host Warranty for given console

     Get Host Warranty based on uuid provided
