...
from ..models.user_facing_log import UserFacingLog
from ..types import UNSET, Unset

T = TypeVar("T", bound="UserFacingLogsPage")


@attr.s(auto_attribs=True)
class UserFacingLogsPage:
    """
    Attributes:
        ...
        log_messages (Union[Unset, List[UserFacingLog]]): List of user facing log objects
    """

    paging_info: Union[Unset, PagingInformation] = UNSET
    log_messages: Union[Unset, List[UserFacingLog]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for log_messages_item_data in _log_messages or []:
            log_messages_item = UserFacingLog.from_dict(log_messages_item_data)

            log_messages.append(log_messages_item)

        user_facing_logs_page = cls(
            paging_info=paging_info,
            log_messages=log_messages,
        )

        user_facing_logs_page.additional_properties = d
        return user_facing_logs_page
