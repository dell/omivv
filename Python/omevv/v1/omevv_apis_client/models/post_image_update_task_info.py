...
T = TypeVar("T", bound="PostImageUpdateTaskInfo")


@attr.s(auto_attribs=True)
class PostImageUpdateTaskInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_image_update_task_info = cls(
            id=id,
            action=action,
            status=status,
            progress=progress,
        ...
        post_image_update_task_info.additional_properties = d
        return post_image_update_task_info
