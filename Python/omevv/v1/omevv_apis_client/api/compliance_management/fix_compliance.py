...
from ...models.fix_compliance_job_request import FixComplianceJobRequest
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: FixComplianceJobRequest,
) -> Dict[str, Any]:
    url = "{}/Consoles/{uuid}/FixCompliance".format(client.base_url, uuid=uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Fix compliance job for selected hosts.
