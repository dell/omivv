...
T = TypeVar("T", bound="PreImageUpdateTaskInfo")


@attr.s(auto_attribs=True)
class PreImageUpdateTaskInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pre_image_update_task_info = cls(
            id=id,
            action=action,
            status=status,
            progress=progress,
        ...
        pre_image_update_task_info.additional_properties = d
        return pre_image_update_task_info
