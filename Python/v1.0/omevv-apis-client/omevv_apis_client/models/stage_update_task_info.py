...
T = TypeVar("T", bound="StageUpdateTaskInfo")


@attr.s(auto_attribs=True)
class StageUpdateTaskInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stage_update_task_info.additional_properties = d
        return stage_update_task_info
