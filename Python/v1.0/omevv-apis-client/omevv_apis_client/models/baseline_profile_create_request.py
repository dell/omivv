...
T = TypeVar("T", bound="BaselineProfileCreateRequest")


@attr.s(auto_attribs=True)
class BaselineProfileCreateRequest:
    """Baseline profile request model.

    Attributes:
        name (Union[Unset, str]): Name of the baseline profile.
        ...
        created_by (Union[Unset, str]): Created user, if not provided it is OMEVV by default
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        baseline_profile_create_request = cls(
            name=name,
        ...
        baseline_profile_create_request.additional_properties = d
        return baseline_profile_create_request
