...
from ...models.un_manage_hosts_request import UnManageHostsRequest
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: UnManageHostsRequest,
) -> Dict[str, Any]:
    url = "{}/Consoles/{uuid}/Hosts/UnManage".format(client.base_url, uuid=uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """OMEVV Management of servers.

     UnInitiate OMEVV Management of servers.
