...
from ...models.manage_hosts_request import ManageHostsRequest
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ManageHostsRequest,
) -> Dict[str, Any]:
    url = "{}/Consoles/{uuid}/Hosts/Manage".format(client.base_url, uuid=uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """OMEVV Management of servers.
     ...
     Initiate OMEVV Management of servers.
