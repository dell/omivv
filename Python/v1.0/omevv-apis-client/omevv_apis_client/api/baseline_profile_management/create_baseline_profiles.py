...
from ...models.baseline_profile_create_request import BaselineProfileCreateRequest
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: BaselineProfileCreateRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uuid (str):
        json_body (BaselineProfileCreateRequest): Baseline profile request model.
