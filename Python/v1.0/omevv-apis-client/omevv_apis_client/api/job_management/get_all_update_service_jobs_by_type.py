...
from ...models.get_all_update_service_jobs_by_type_jobtype import GetAllUpdateServiceJobsByTypeJobtype
...
def _get_kwargs(
    ...
    *,
    ...
    jobtype: Union[Unset, None, GetAllUpdateServiceJobsByTypeJobtype] = UNSET,
) -> Dict[str, Any]:
    url = "{}/Consoles/{uuid}/UpdateJobs".format(client.base_url, uuid=uuid)
...
def sync_detailed(
    ...
    *,
    ...
    """Get all jobs by type
     ...
     Gets the list of  the update service jobs

    Args:
        uuid (str):
        jobtype (Union[Unset, None, GetAllUpdateServiceJobsByTypeJobtype]):
