...
def _parse_response(*, response: httpx.Response) -> Optional[Union[ErrorObject, str]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[ErrorObject, str]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    client: Client,
) -> Response[Union[ErrorObject, str]]:
    """purge discovery job by id

     Delete discovery service job by id
...
def sync(
    ...
    *,
    client: Client,
) -> Optional[Union[ErrorObject, str]]:
    """purge discovery job by id
