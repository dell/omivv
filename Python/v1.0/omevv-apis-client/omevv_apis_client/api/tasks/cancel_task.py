...
def _parse_response(*, response: httpx.Response) -> Optional[Union[EmptySuccessResponse, ErrorResponse]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[EmptySuccessResponse, ErrorResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    client: Client,
    v_center_instance_guid: Union[Unset, str] = UNSET,
) -> Response[Union[EmptySuccessResponse, ErrorResponse]]:
...
def sync(
    ...
    *,
    client: Client,
    v_center_instance_guid: Union[Unset, str] = UNSET,
) -> Optional[Union[EmptySuccessResponse, ErrorResponse]]:
    """Cancel an active task
