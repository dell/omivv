...
from ...models.repo_test_connection_request import RepoTestConnectionRequest
...
def _get_kwargs(
    *,
    ...
    json_body: RepoTestConnectionRequest,
) -> Dict[str, Any]:
    url = "{}/RepositoryProfiles/TestConnection".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """Test connection for repository profile share

    Args:
        json_body (RepoTestConnectionRequest): Model for test connection
