...
from ...models.host_update_request import HostUpdateRequest
...
def sync_detailed(
    ...
    *,
    ...
    """Precheck/Stage/Pre-image Update/Post-image Update FW updates as needed on a host for firmware
    compliance
