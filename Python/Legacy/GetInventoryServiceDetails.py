...
"""
SYNOPSIS:
   Script to get the different host details for a given host id

DESCRIPTION:
   This script exercises the Spectre REST API to get the different 
   host details for a given host id. For authentication X-Auth is used over Basic
   Authentication
   Note that the credentials entered are not stored to disk.

EXAMPLE:
   python GetInventoryServiceDetails.py  --ip <xx>  --user <username> --password <pwd> --vcenterip <vcenterIP>
...
def get_vcenter_tree(ip_address, user_name, password, bearer_token, vcenter_ip,  vc_username, vc_domain, vc_password, host_id, details):
...
if __name__ == '__main__':
    ...
    get_vcenter_tree(ARGS.ip, ARGS.user, ARGS.password, ARGS.bearertoken, ARGS.vcenterip,  ARGS.vcusername, ARGS.vcdomain, ARGS.vcpassword, ARGS.hostId, ARGS.getdetails)
