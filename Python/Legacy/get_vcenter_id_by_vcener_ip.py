#
#  Python script using OMIVV API to get the vcenter id by given vcenter ip
#
...
"""
SYNOPSIS:
   Script to get the list of VCenter id
...
EXAMPLE:
    python get_vcenter_id_by_vcener_ip.py --ip <xxxx> --user <xxxx>
     --password <xxxx> --vcenterip <xxxx>
"""
import sys
import argparse
...
def get_vcenter_id(ip_address, user_name, password, vcenter_ip):
...
if __name__ == '__main__':
    ...
    get_vcenter_id(ARGS.ip, ARGS.user, ARGS.password,ARGS.vcenterip)
