...
def get_vcenter_tree(ip_address, user_name, password, vcenter_ip, host_id, vc_username, vc_domain, vc_password):
    ...
    try:
        ...
        if flag:
            ...
            for cluster_href in cluster_list:
                ...
                for host in hosts_list:
                    if host['id'] == host_id:
                        ...
                        cluster_flag = True
                        print("Host id: " + host_id + ", cluster id: " + cluster_json_response['id'])
                        break
                if cluster_flag:
                        break;
            ...
            print("Host is not inside a cluster. It is inside the datacenter:  " + datacenter_name)
        """ Log out from OMIVV """
...
if __name__ == '__main__':
    ...
    PARSER.add_argument("--vcenterip", "-vcip", required=True,
                        help="IP for vcenter")
    PARSER.add_argument("--hostid", "-hostid", required=True,
                        help="host id of the host")
    ...
    get_vcenter_tree(ARGS.ip, ARGS.user, ARGS.password,ARGS.vcenterip, ARGS.hostid, ARGS.vcusername, ARGS.vcdomain, ARGS.vcpassword)
